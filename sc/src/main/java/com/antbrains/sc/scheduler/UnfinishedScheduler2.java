...
public class UnfinishedScheduler2 extends StopableWorker {
	protected static Logger logger = Logger.getLogger(UnfinishedScheduler2.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String helpStr = "UnfinishedScheduler conAddr jmxUrl queueName";
		args = line.getArgs();
		if (args.length != 3) {
		...
		UnfinishedScheduler2 scheduler = new UnfinishedScheduler2(args[0], args[1], maxQueueSize, batchSize,
				maxEmptyCount, args[2], maxFailCount);
