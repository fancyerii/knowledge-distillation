package com.antbrains.takungpao_es.preprocess;
...
public class PreprocessArticle {
	...
	Article parseNews(NekoHtmlParser p, String url) {
		...
		// String pubStr =
		// p.getNodeText("//SPAN[@itemprop='datePublished']").trim();
		NodeList infoNodes = p.selectNodes("//DIV[@class='fl_dib']");
		if (infoNodes.getLength() != 2)
			return null;
